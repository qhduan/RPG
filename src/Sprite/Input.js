...
/**
 * @fileoverview Class SpriteInput
  ...
  */
  static isPressed (key) {
    if (Number.isFinite(key)) {
      ...
      console.error(key);
      throw new Error("SpriteInput.isPressed got invalid argument");
    }
  }
  ...
  */
  static whenPress (keys, callback) {
    if (callback) {
      ...
      throw new Error("SpriteInput.whenPress got invalid arguments");
    }
  }
  ...
  */
  static whenDown (keys, callback) {
    if (callback) {
      ...
      console.error(callback);
      throw new Error("SpriteInput.whenDown got invalid arguments");
    }
  }
  ...
  */
  static whenUp (keys, callback) {
    if (callback) {
      ...
      console.error(callback);
      throw new Error("SpriteInput.whenUp got invalid arguments");
    }
  }
}
