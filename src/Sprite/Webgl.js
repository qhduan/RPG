...
/**
 * @fileoverview Define the SpriteWebgl, a renderer, other choice from SpriteCanvas
...
export default class Webgl {
  ...
  constructor (width, height) {
    ...
    if (!gl) {
      throw new Error("SpriteWebgl webgl is not supported");
    }
    ...
    console.log("SpriteWebgl inited, max texture size: %d",
  ...
  drawImage (image, sx, sy, sw, sh, dx, dy, dw, dh) {
    if (arguments.length == 9) {
      ...
      throw new Error("SpriteWebgl.drawImage invalid arguments");
    }
    ...
    if (
      ...
      throw new Error("SpriteWebgl.drawImage invalid image");
    }
    */
  ...
  set alpha (value) {
    ...
    if (Number.isFinite(value) &&
      ...
      throw new Error("SpriteWebgl got invalid alpha number");
    }
  }
  ...
  set color (value) {
    ...
    if (m) {
      ...
      console.error(value, this);
      throw new Error("SpriteWebgl.color invalid color format");
    }
  }
  ...
  set width (value) {
    ...
    if (Number.isFinite(value) &&
      ...
      console.error(value, this);
      throw new Error("SpriteWebgl got invalid width number");
    }
  }
  ...
  set height (value) {
    ...
    if (Number.isFinite(value) &&
      ...
      console.error(value, this);
      throw new Error("SpriteWebgl got invalid height number");
    }
  }
  ...
  set canvas (value) {
    console.error(value, this);
    throw new Error("SpriteWebgl.canvas cannot write");
  }
