    ...
    function MapClass(mapData) {
      ...
      loader.on("complete", function (event) {
        ...
        minimap.onload = function () {
          _this.minimap = new Sprite.Bitmap(minimap);
          _this.minimap.width = minimap.width;
          _this.minimap.height = minimap.height;
          _this.minimap.center.x = parseInt(minimap.width / 2);
          _this.minimap.center.y = parseInt(minimap.height / 2);
        };
