...
(function () {
  ...
  function rectngleCollide (spriteA, spriteB, rectA, rectB) {
    ...
    if( data.width < (rectA.rect.width + rectB.rect.width)
    && data.height < (rectA.rect.height + rectB.rect.height) )
      return data;
    return false;
  }
  ...
  function pixelCollide (spriteA, spriteB, rectA, rectB, data,
    ...
    context.drawImage(rectA.image,
      rectA.rect.x, rectA.rect.y, data.w1, data.h1,
    ...
    context.drawImage(rectB.image,
      rectB.rect.x, rectB.rect.y, data.w2, data.h2,
