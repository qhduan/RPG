...
(function () {
  ...
  var HeroDefault = {
    ...
    items: [
      { id: "spearIron", count: 1 },
      { id: "bowWood", count: 1 },
      { id: "potionHealWeak", count: 5 }
    ],
    ...
    animations: {
      spellcastup: [0, 6, "", 400],
      spellcastleft: [13, 19, "", 400],
      spellcastdown: [26, 32, "", 400],
      spellcastright: [39, 45, "", 400],

      thrustup: [52, 59, "", 400],
      thrustleft: [65, 72, "", 400],
      thrustdown: [78, 85, "", 400],
      thrustright: [91, 98, "", 400],
      ...
      slashup: [156, 161, "", 400],
      slashleft: [169, 174, "", 400],
      slashdown: [182, 187, "", 400],
      slashright: [195, 200, "", 400],

      shootup: [208, 220, "", 400],
      shootleft: [221, 233, "", 400],
      shootdown: [234, 246, "", 400],
      shootright: [247, 259, "", 400],
