...
function CreateSession (hero) {
  ...
  hero.animations = {
    spellcastup: [0, 6, "", 0.2],
    spellcastleft: [13, 19, "", 0.2],
    spellcastdown: [26, 32, "", 0.2],
    spellcastright: [39, 45, "", 0.2],

    thrustup: [52, 59, "", 0.25],
    thrustleft: [65, 72, "", 0.25],
    thrustdown: [78, 85, "", 0.25],
    thrustright: [91, 98, "", 0.25],

    walkup: [104, 112, "", 0.25],
    walkleft: [117, 125, "", 0.25],
    walkdown: [130, 138, "", 0.25],
    walkright: [143, 151, "", 0.25],

    runup: [104, 112, "", 0.5],
    runleft: [117, 125, "", 0.5],
    rundown: [130, 138, "", 0.5],
    runright: [143, 151, "", 0.5],

    slashup: [156, 161, "", 0.3],
    slashleft: [169, 174, "", 0.3],
    slashdown: [182, 187, "", 0.3],
    slashright: [195, 200, "", 0.3],

    shootup: [208, 220, "", 0.3],
    shootleft: [221, 233, "", 0.3],
    shootdown: [234, 246, "", 0.3],
    shootright: [247, 259, "", 0.3],
