...
(function () {
  ...
  Game.init = function () {
    ...
    Game.stage.appendChild(Game.layers.mapLayer, Game.layers.itemLayer, Game.layers.actorLayer, Game.layers.infoLayer, Game.layers.skillLayer, Game.layers.dialogueLayer);
