...
/**
 * @fileoverview Class SpriteContainer, it's a general container
 * Contain SpriteSheet, SpriteBitmap, SpriteShape, SpriteText, SpriteFrame or SpriteContainer
...
export default class SpriteContainer extends SpriteDisplay {
  ...
  set children (value) {
    throw new Error("SpriteContainer.children readonly");
  }
  ...
  set cacheCanvas (value) {
    throw new Error("SpriteContainer.cacheCanvas readonly");
  }
  ...
  set cacheX (value) {
    throw new Error("SpriteContainer.cacheX readonly");
  }
  ...
  set cacheY (value) {
    throw new Error("SpriteContainer.cacheY readonly");
  }
   ...
   * @param {Object} renderer SpriteWebgl/SpriteCanvas/Context
   */
  draw (renderer) {
    let privates = internal(this);
  ...
  */
  ...
  appendChild () {
    ...
    if (args.length <= 0) {
      throw new Error("SpriteContainer.appendChild got an invalid arguments");
    }
  ...
  appendChildAt () {
    ...
    if (args.length <= 1) {
      ...
      throw new TypeError("SpriteContainer.appendChildAt has an invalid arguments");
    }
