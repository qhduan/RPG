...
(function () {
  ...
  Game.ui.hint = function () {
    if (Game.hintObject) {
      ...
      } else if (Game.hintObject.type && Game.hintObject.type == "chest") {} else if (Game.hintObject instanceof Game.ActorClass) Game.hintObject.contact();else if (Game.hintObject instanceof Game.ItemClass) Game.hintObject.pickup();
    }
  };
